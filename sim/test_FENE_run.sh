...
OUT=/home/chengling/Research/Project/vitrimer/data/test/RevEp100KTFENE
...
declare -a KT_LIST=(0.1 0.01 0.001 0.0001)
...
for kT in "${KT_LIST[@]}"; do
  for rho in "${RHO_LIST[@]}"; do
    ...
    $PY /home/chengling/Research/Project/vitrimer/sim/test_FENE.py \
      --kT "$kT" \
      --rho "$rho" \
